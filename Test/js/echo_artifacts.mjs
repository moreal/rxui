...
if (
  ...
  JSON.stringify(manifest.features) !== JSON.stringify(
    ["scalar", "events", "transactions", "instrumentation", "trace", "typed-events"],
  )
) {
...
for (const required of [
  ...
  "listenValue(node_3, \"input\", state, context, $lrx_typed_event_0)",
  "listenKey(node_3, \"keydown\", state, context, $lrx_typed_event_1)",
  "listenValue(node_4, \"change\", state, context, $lrx_typed_event_2)",
]) {
