...
for (const required of [
  ...
  "const regions = [[region_0, [], 0, false, [], [count_text_22, count_text_24], [0, 0], [], 0, [0]], [region_1, [], 0, false, [], [], 0], [region_2, [], 0, false, [], [], 0]];",
  // Each region's wake flag is its own, read before the reconcile consumes
  // the dirty bit and the pending positions.
  "    const region_touched_1 = regions[1][3] || regions[1][5][\"length\"] !== 0 || regions[1][6] !== 0 || regions[1][4][\"length\"] !== 0;",
  "    const region_touched_2 = regions[2][3] || regions[2][5][\"length\"] !== 0 || regions[2][6] !== 0 || regions[2][4][\"length\"] !== 0;",
