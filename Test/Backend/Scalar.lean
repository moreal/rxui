...
def run : IO Unit := do
  ...
  unless manifest ==
      "{\"compilerVersion\":\"0.1.0-dev\",\"leanToolchain\":\"leanprover/lean4:v4.33.0\",\"module\":\"subtotal.mjs\",\"runtimeAbi\":11,\"exports\":[\"subtotal\"],\"inputs\":[{\"name\":\"price\",\"generatedName\":\"price\",\"type\":\"int\"},{\"name\":\"quantity\",\"generatedName\":\"quantity\",\"type\":\"int\"},{\"name\":\"threshold\",\"generatedName\":\"threshold\",\"type\":\"int\"}],\"resultType\":\"int\",\"features\":[\"scalar\"]}\n" do
