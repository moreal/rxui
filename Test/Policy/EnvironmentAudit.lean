...
elab "#leanrx_environment_audit" : command => do
  ...
  let reviewedUnsafe : Array Name := #[
    ...
    `LeanRx.ReactiveIR.Expr.erasureReport._unsafe_rec,
    `LeanRx.ReactiveIR.erasedStaticEvidence._unsafe_rec,
    ...
    `LeanRx.RowExpr.hasTrim._unsafe_rec,
    `LeanRx.RowNode.hasTrim._unsafe_rec,
    `LeanRx.RowChildren.hasTrim._unsafe_rec,
    `LeanRx.RowNode.childRefs._unsafe_rec,
    `LeanRx.RowChildren.childRefs._unsafe_rec,
    `LeanRx.View.hasStaticId._unsafe_rec,
    `LeanRx.ViewChildren.hasStaticId._unsafe_rec,
    `LeanRx.RowNode.hasStaticId._unsafe_rec,
    `LeanRx.RowChildren.hasStaticId._unsafe_rec,
    `LeanRx.RowChildren.ofList._unsafe_rec,
    `LeanRxDsl.componentPropNames.unsafe_1,
    `LeanRxDsl.componentStaticIdTrail.unsafe_1,
    ...
    `LeanRx.Backend.ManifestTypeId.debug._unsafe_rec,
    `LeanRx.Backend.ManifestTypeId.ofRuntime._unsafe_rec,
    `LeanRx.Backend.instBEqManifestTypeId.beq._unsafe_rec,
    `LeanRx.Backend.instDecidableEqManifestTypeId.decEq._unsafe_rec,
    `LeanRx.Backend.instReprManifestTypeId.repr._unsafe_rec,
  ...
  let reviewedAxiomUses : Array (Name × Array Name) := #[
    ...
    (`LeanRx.RowNode.child.injEq, #[``propext]),
    (`LeanRx.RowExpr.lit.injEq, #[``propext]),
    (`LeanRx.RowChildProp.lit.injEq, #[``propext]),
    (`LeanRx.RowChildProp.field.injEq, #[``propext]),
    ...
    (`LeanRx.PersistSpec.mk.injEq, #[``propext]),
    ...
    (`LeanRx.AttrSelect.hiddenIfEmpty.injEq, #[``propext]),
    (`LeanRx.AttrSelect.checkedIfEmpty.injEq, #[``propext]),
    (`LeanRx.FieldPredicate.mk.injEq, #[``propext]),
    (`LeanRx.RowStage.mk.injEq, #[``propext]),
    ...
    (`LeanRx.Form.ValidationError.mk.injEq, #[``propext]),
    (`LeanRx.Form.Parser.mk.injEq, #[``propext]),
    (`LeanRx.Form.Validator.mk.injEq, #[``propext]),
    (`LeanRx.Form.TemperatureEdit.mk.injEq, #[``propext]),
    (`LeanRx.Form.TemperatureResult.mk.injEq, #[``propext]),
    (`LeanRx.Form.RawForm.mk.injEq, #[``propext]),
    (`LeanRx.Form.FormErrors.mk.injEq, #[``propext]),
    ...
    (`LeanRx.Region.PositionalInstance.mk.injEq, #[``propext]),
    (`LeanRx.Region.reconcilePositional_logical, #[``propext]),
    ...
    (`LeanRx.Collection.PlannedDeltas.create._proof_2, #[``propext]),
    (`LeanRx.Grid.plannedDeltas_correct, #[``propext, ``Quot.sound]),
    (`LeanRx.Grid.CostModel.mk.injEq, #[``propext]),
    (`LeanRx.Grid.Error.mk.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.createRows.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.removeEvery.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.select.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.setFilter.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.setSort.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.swap.injEq, #[``propext]),
    (`LeanRx.Grid.Operation.updateOne.injEq, #[``propext]),
    (`LeanRx.Grid.Row.mk.injEq, #[``propext]),
    (`LeanRx.Grid.Step.mk.injEq, #[``propext]),
    (`LeanRx.Grid.TraceResult.mk.injEq, #[``propext]),
    (`LeanRx.Grid.Work.mk.injEq, #[``propext]),
    (`LeanRx.JsFrameworkBenchmark.Operation.delete.injEq, #[``propext]),
    (`LeanRx.JsFrameworkBenchmark.Operation.select.injEq, #[``propext]),
    (`LeanRx.JsFrameworkBenchmark.Row.mk.injEq, #[``propext]),
    (`LeanRx.Todo.Item.mk.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.setNewTitle.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.toggle.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.delete.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.setFilter.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.startEditing.injEq, #[``propext]),
    (`LeanRx.Todo.Msg.setDraft.injEq, #[``propext]),
    (`LeanRx.Effect.Resource.cancel_stale, #[``propext]),
    (`LeanRx.Effect.Resource.cancel.eq_1, #[``propext]),
    (`LeanRx.Effect.Resource.cancel.eq_2, #[``propext]),
    (`LeanRx.Effect.Resource.cancel._sparseCasesOn_1.else_eq, #[``propext]),
    (`LeanRx.Effect.Resource.settle_stale, #[``propext]),
    (`LeanRx.Effect.Resource.settle.eq_1, #[``propext]),
    (`LeanRx.Effect.Resource.settle.eq_2, #[``propext]),
    (`LeanRx.Effect.Resource.settle.eq_3, #[``propext]),
    (`LeanRx.Effect.Cmd.batch.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.cancel.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.foreign.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.http.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.storageGet.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.storageSet.injEq, #[``propext]),
    (`LeanRx.Effect.Cmd.timeout.injEq, #[``propext]),
    (`LeanRx.Effect.Error.mk.injEq, #[``propext]),
    (`LeanRx.Effect.HttpRequest.mk.injEq, #[``propext]),
    (`LeanRx.Effect.HttpResponse.mk.injEq, #[``propext]),
    (`LeanRx.Effect.Resource.cancelled.injEq, #[``propext]),
    (`LeanRx.Effect.Resource.failure.injEq, #[``propext]),
    (`LeanRx.Effect.Resource.loading.injEq, #[``propext]),
    (`LeanRx.Effect.Resource.success.injEq, #[``propext]),
    (`LeanRx.Effect.StorageResult.found.injEq, #[``propext]),
    (`LeanRx.Effect.PortTypeId.array.injEq, #[``propext]),
    (`LeanRx.Effect.PortTypeId.record.injEq, #[``propext]),
    (`LeanRx.Effect.PortTypeId.runtime.injEq, #[``propext]),
    (`LeanRx.Effect.PortRecord.mk.injEq, #[``propext]),
    (`LeanRx.Effect.PortRep.array.injEq, #[``propext]),
    (`LeanRx.Effect.PortRep.runtime.injEq, #[``propext]),
    (`LeanRx.Notes.Msg.debounceFired.injEq, #[``propext]),
    (`LeanRx.Notes.Msg.edit.injEq, #[``propext]),
    (`LeanRx.Notes.Msg.restored.injEq, #[``propext]),
    (`LeanRx.Notes.Msg.stored.injEq, #[``propext]),
    (`LeanRx.Notes.Persistence.failed.injEq, #[``propext]),
    (`LeanRx.Notes.Persistence.saving.injEq, #[``propext]),
    (`LeanRx.Notes.Persistence.scheduled.injEq, #[``propext]),
    (`LeanRx.IssueBrowser.Issue.mk.injEq, #[``propext]),
    (`LeanRx.IssueBrowser.Page.mk.injEq, #[``propext]),
    (`LeanRx.IssueBrowser.RequestKey.mk.injEq, #[``propext]),
    (`LeanRx.IssueBrowser.Msg.received.injEq, #[``propext]),
    (`LeanRx.IssueBrowser.Msg.setQuery.injEq, #[``propext]),
    ...
    (`LeanRx.Backend.ManifestTypeId.vector.injEq, #[``propext]),
    ...
    (`LeanRx.Js.Stmt.whileLoop.injEq, #[``propext]),
    ...
    (`LeanRx.Lower.rxExpr._unary._proof_7, #[``propext, ``Quot.sound]),
    (`LeanRx.Lower.rxExpr._unary._proof_8, #[``propext, ``Quot.sound]),
    ...
    (`LeanRx.ReactiveIR.Expr.vectorGet.injEq, #[``propext]),
    (`LeanRx.ReactiveIR.Expr.erasureReport_no_inspections, #[``propext]),
    (`LeanRx.ReactiveIR.ErasureReport.mk.injEq, #[``propext]),
    (`LeanRx.ReactiveIR.ErasureReport.Error.mk.injEq, #[``propext]),
    (`LeanRx.ReactiveIR.StaticEvidence.vectorLength.injEq, #[``propext]),
    (`LeanRx.ReactiveIR.StaticEvidence.finBound.injEq, #[``propext]),
    ...
    (`LeanRx.RxExpr.debug._unary._proof_7, #[``propext, ``Quot.sound]),
    (`LeanRx.RxExpr.debug._unary._proof_8, #[``propext, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_def, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_1, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_2, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_3, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_4, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_5, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval.eq_6, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.eval._unary.eq_def, #[``propext, ``Classical.choice, ``Quot.sound]),
    ...
    (`LeanRx.RxExpr.eval._unary._proof_7, #[``propext, ``Quot.sound]),
    (`LeanRx.RxExpr.eval._unary._proof_8, #[``propext, ``Quot.sound]),
    (`LeanRx.RxExpr.vectorGetWith.injEq, #[``propext]),
    -- The ADR-0055 stringTrim case makes `RxExpr.eval` reference
    -- `String.trimAscii`, whose core UTF-8 machinery is classical: the
    -- congruence theorem's own proof is unchanged, but its transitive
    -- manifest now carries `Classical.choice` from that reference.
    (`LeanRx.RxExpr.eval_congr_on_deps, #[``propext, ``Classical.choice, ``Quot.sound]),
    (`LeanRx.RxExpr.ifThenElse.injEq, #[``propext]),
    (`LeanRx.RxExpr.literal.injEq, #[``propext]),
    (`LeanRx.RxExpr.readWith.injEq, #[``propext]),
    (`LeanRx.RxExpr.toAbstractEval._proof_1, #[``propext, ``Classical.choice, ``Quot.sound]),
    ...
    (`LeanRx.Cli.Command.explain.injEq, #[``propext]),
    (`LeanRx.Cli.Command.graph.injEq, #[``propext]),
    (`LeanRx.Cli.Command.scaffold.injEq, #[``propext]),
    (`LeanRx.Cli.Explanation.mk.injEq, #[``propext]),
    (`LeanRx.Cli.Error.mk.injEq, #[``propext]),
    (`LeanRx.AnyTypedEvent.bool.injEq, #[``propext]),
    (`LeanRx.AnyTypedEvent.boolBroadcast.injEq, #[``propext]),
    ...
    (`LeanRx.Docs.RenderedPage.mk.injEq, #[``propext]),
    (`LeanRx.Docs.Markdown.Error.mk.injEq, #[``propext]),
    (`LeanRx.MountChildren.cons.injEq, #[``propext]),
    (`LeanRx.MountedChild.mk.injEq, #[``propext]),
    ...
    (`LeanRx.View.child.injEq, #[``propext]),
    ...
    (`LeanRx.MountNode.propText.injEq, #[``propext]),
    (`LeanRx.KeyEventArm.mk.injEq, #[``propext]),
    (`LeanRx.KeyEventSpec.mk.injEq, #[``propext]),
    ...
    (`LeanRx.RowEventSpec.mk.injEq, #[``propext]),
    (`LeanRx.RowNode.branch.injEq, #[``propext]),
    (`LeanRx.RowNode.element.injEq, #[``propext]),
